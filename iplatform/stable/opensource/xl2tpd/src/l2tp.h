...
# define _LOG_RECV_ZLB     (301)
# define _LOG_SEND_SCCRQ   (302)
# define _LOG_RECV_SCCRP   (303)
# define _LOG_SEND_SCCCN   (304)
# define _LOG_SEND_ICRQ    (305)
# define _LOG_RECV_ICRP    (306)
# define _LOG_SEND_ICCN    (307)
# define _LOG_SEND_STOPCCN (308)
# define _LOG_NO_TID (321)
# define _LOG_NO_AUTH      (322)
# define _LOG_NO_FC        (323)
# define _LOG_NO_HOSTNAME  (324)
# define _LOG_INVALID_AUTH (325)
# define _LOG_INVALID_TID  (326)
# define _LOG_NO_RC        (327)
# define _LOG_NO_CID       (328)
#endif
