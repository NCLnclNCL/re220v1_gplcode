...
struct ubus_method CamuleUbusRpc::amule_ubus_object_methods[] = {
	{ .name = "amuleShutdown",        .handler = AmuleUbusShutdownHandle,        .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleAddLink",         .handler = AmuleUbusAddLinkHandle,         .policy = amule_add_link_policy,  .n_policy = ARRAY_SIZE(amule_add_link_policy)},
	{ .name = "amuleShowAllDl",       .handler = AmuleUbusShowDlHandle,          .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleGetDlFilesStatus",.handler = AmuleUbusGetDlStatusHandle,     .policy = amule_file_op_policy,   .n_policy = ARRAY_SIZE(amule_file_op_policy)},
    { .name = "amuleIsFileCompleted", .handler = AmuleUbusIsFileCompletedHandle, .policy = amule_file_op_policy,   .n_policy = ARRAY_SIZE(amule_file_op_policy)},
	{ .name = "amuleFileDlResume",    .handler = AmuleUbusFileDlResumeHandle,    .policy = amule_file_op_policy,   .n_policy = ARRAY_SIZE(amule_file_op_policy)},
	{ .name = "amuleFileDlPause",     .handler = AmuleUbusFileDlPauseHandle,     .policy = amule_file_op_policy,   .n_policy = ARRAY_SIZE(amule_file_op_policy)},
	{ .name = "amuleFileDlDelete",    .handler = AmuleUbusFileDlDeleteHandle,    .policy = amule_file_op_policy,   .n_policy = ARRAY_SIZE(amule_file_op_policy)},
	{ .name = "amuleFileDlDeleteAll", .handler = AmuleUbusFileDlDeleteAllHandle, .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleServerAdd",       .handler = AmuleUbusServerAddHandle,       .policy = amule_server_op_policy, .n_policy = ARRAY_SIZE(amule_server_op_policy)},
	{ .name = "amuleServerRemoveAll", .handler = AmuleUbusServerRemoveAllHandle, .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleServerRemove",    .handler = AmuleUbusServerRemoveHandle,    .policy = amule_server_op_policy, .n_policy = ARRAY_SIZE(amule_server_op_policy)},
	{ .name = "amuleServerConnect",   .handler = AmuleUbusServerConHandle,       .policy = amule_server_op_policy, .n_policy = ARRAY_SIZE(amule_server_op_policy)},		
	{ .name = "amuleServerDisconnect",.handler = AmuleUbusServerDisconHandle,    .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleServerStatus",    .handler = AmuleUbusServerStatusHandle,    .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleServerList",      .handler = AmuleUbusServerListHandle,      .policy = NULL,                   .n_policy = 0},
	{ .name = "amuleSetPref",         .handler = AmuleUbusSetPrefHandle,         .policy = amule_pref_policy,      .n_policy = ARRAY_SIZE(amule_pref_policy)},
	{ .name = "amuleGetPref",         .handler = AmuleUbusGetPrefHandle,         .policy = NULL,                   .n_policy = 0}
};
struct ubus_object_type CamuleUbusRpc::amule_ubus_object_type =
	{ .name = "amule_ubus_type", .id = 0, .methods = amule_ubus_object_methods, .n_methods = ARRAY_SIZE(amule_ubus_object_methods)};
