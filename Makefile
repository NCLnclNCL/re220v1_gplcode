...
# 删除target tools toolchain的部分，需要字段改为外部输入
...
$(package/stamp-cleanup): $(tools/stamp-install) $(BUILD_DIR)/.prepared
$(package/stamp-compile): $(tools/stamp-install) $(BUILD_DIR)/.prepared $(package/stamp-cleanup)
$(package/stamp-install): $(package/stamp-compile)
$(package/stamp-rootfs-prepare): $(package/stamp-install)
...
prepare: .config $(tools/stamp-install)

#world: prepare $(target/stamp-compile) $(package/stamp-cleanup) $(package/stamp-compile) $(package/stamp-install) $(package/stamp-rootfs-prepare) $(target/stamp-install) FORCE
#	$(_SINGLE)$(SUBMAKE) -r package/index

world: prepare $(package/stamp-cleanup) $(package/stamp-compile) $(package/stamp-install) $(package/stamp-rootfs-prepare) FORCE
	$(_SINGLE)$(SUBMAKE) -r package/index
